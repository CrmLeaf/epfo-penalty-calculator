...
return [
    ...
    | EPFO_PENALTY_CALCULATOR_ROUTE=true, and the tool mounts at
    | /<prefix>/epfo-penalty-calculator answering both GET and POST.
    |
    */

    'route' => [
        'enabled' => env('EPFO_PENALTY_CALCULATOR_ROUTE', false),
        'prefix' => env('EPFO_PENALTY_CALCULATOR_PREFIX', 'tools'),
        'name' => 'epfo-penalty-calculator',
