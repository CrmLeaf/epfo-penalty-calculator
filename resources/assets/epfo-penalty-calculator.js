/*
 * Progressive enhancement for EPFO Penalty Calculator.
 *
...
(function () {
    ...
    var TOOL = 'epfo-penalty-calculator';
    var CALCULATOR = 'epfoPenalty';
    var FIELDS = [
        { name: 'contribution_amount', argument: 'contributionAmount', type: 'money' },
        { name: 'wage_month', argument: 'wageMonth', type: 'date' },
        { name: 'actual_payment_date', argument: 'actualPaymentDate', type: 'date' },
